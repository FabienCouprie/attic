// ui/FormeOnde.tsx — Canvas de forme d'onde + sélection de zones.
// Haute résolution (DPR), barre de défilement, redimensionnable (NodeResizer),
// zoom fluide (molette + slider). Utilisé par « visualiseur-forme-onde » et
...
export function FormeOnde({ audioUrl, multi, zones, onZonesChange }: Props) {
  ...
  const dessiner = useCallback(() => {
    ...
    const hauteurCSS = multi ? 140 : 100;
    ...
    const couleurOnde = multi ? "#2a9d8f" : "#4c6ef5";
  ...
  }, [buffer, zones, multi, calculerZoom, isPlaying, playPos]);
    ...
    <div className="attic-node-onde nodrag" onClick={(e) => e.stopPropagation()} onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div ref={containerRef} style={{ position: "relative", width: "100%" }}>
        <canvas
          ...
          style={{ cursor: multi ? "crosshair" : "pointer", display: "block", borderRadius: 4 }}
        />
        {/* Barre de défilement */}
        {buffer && maxScroll > 0 && (
          <div
