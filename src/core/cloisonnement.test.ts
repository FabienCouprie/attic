...
const reverb: PluginDef<TypeValeur, AudioContext> = {
  ...
  notice: "Nœud de test pour le cloisonnement audio.",
  noticeEn: "Test node for audio isolation.",
...
const generer: PluginDef<number, null> = {
  ...
  notice: "Nœud de test pour le cloisonnement nombre.",
  noticeEn: "Test node for number isolation.",
  entrees: [],
