...
export const fiches: FicheAudio[] = ([
  ...
  },
  {
    ...
    notice: "D'après Joseph Schillinger, « The Schillinger System of Musical Composition », Carl Fischer, 1946, livre I : « Theory of Rhythm ».\n\nAttic engendre déjà du rythme de six façons : euclidien, Cantor, automate cellulaire, L-système, cribles de Xenakis, pulsars de Roads. La résultante n'est aucune d'elles, et le contraste avec l'euclidien est net. Celui-ci répartit des frappes le plus également possible sur un cycle ; celle-là superpose deux périodes et laisse le motif tomber où il tombe. L'un cherche la régularité, l'autre la produit par accident — et c'est de ce hasard réglé que sortent les figures que Schillinger poursuivait.\n\nDeux pulsations de 3 et 2 donnent 2-1-1-2, la figure la plus reconnaissable du système. Elle est palindromique, et ce n'est pas un hasard : la résultante de deux nombres premiers entre eux l'est toujours, par symétrie du cycle autour de son milieu.\n\nCe qu'il faut savoir avant de régler. Le cycle dure le produit des deux périodes, mais si celles-ci partagent un facteur, elles retombent ensemble avant la fin et le motif se répète à l'intérieur de lui-même : la résultante de 4 et 2 n'est pas plus riche que celle de 2 et 1, c'est la même, jouée deux fois plus lentement. Le nœud le dit plutôt que de laisser croire à un réglage sans effet.\n\nCe que ce nœud ne fait pas : le fractionnement, par lequel Schillinger enrichit ses résultantes et obtient des structures auto-similaires. Les sources consultées nomment la technique sans en donner la règle, et une opération portant son nom sans pouvoir être confrontée à une figure publiée aurait été une invention sous une autorité empruntée.",
    noticeEn: "After Joseph Schillinger, « The Schillinger System of Musical Composition », Carl Fischer, 1946, book I: « Theory of Rhythm ».\n\nAttic already generates rhythm in six ways: Euclidean, Cantor, cellular automaton, L-system, Xenakis sieves, Roads pulsars. The resultant is none of them, and the contrast with the Euclidean is sharp. The latter spreads onsets as evenly as possible over a cycle; the former superposes two periods and lets the pattern fall where it falls. One seeks regularity, the other produces it by accident — and from that governed chance come the figures Schillinger pursued.\n\nTwo pulses of 3 and 2 give 2-1-1-2, the system's most recognisable figure. It is palindromic, and that is no accident: the resultant of two coprime numbers always is, by symmetry of the cycle about its midpoint.\n\nWhat to know before setting it. The cycle lasts the product of the two periods, but if they share a factor they fall together before the end and the pattern repeats inside itself: the resultant of 4 and 2 is no richer than that of 2 and 1, it is the same, played twice as slowly. The node says so rather than letting one believe in a setting with no effect.\n\nWhat this node does not do: fractioning, by which Schillinger enriches his resultants and obtains self-similar structures. The sources consulted name the technique without giving its rule, and an operation bearing his name that could not be checked against a published figure would have been an invention under a borrowed authority.",
    entrees: [],
    sorties: [
      { nom: "Analyse", nomEn: "Analysis", type: "texte" },
    ...
    parametres: [
      ...
      { nom: "Pulsation B", nomEn: "Pulse B", type: "curseur", plage: [1, 16], pas: 1, defaut: 2,
        doc: "Période de la seconde. Prenez-la première avec la première : sans cela le motif se répète à l'intérieur du cycle, et le nœud vous le dira.",
  ...
  },
  {
    ...
    notice: "Le nœud Gamme connaissait sept modes d'église et deux pentatoniques ; le nœud Tempérament, les tempéraments occidentaux historiques. Ni maqam, ni raga, ni gamelan.\n\nCe n'était pas un oubli de liste : ces systèmes ne tiennent pas dans les douze demi-tons égaux. Le maqam Rast a une tierce à mi-chemin entre la majeure et la mineure ; les shrutis indiennes divisent l'octave en vingt-deux degrés inégaux ; le slendro javanais n'a ni octave juste ni intervalle égal. Les écrire demande des cents, pas des numéros de note — et c'est pour cela que ce nœud rend des fréquences et jamais des touches.\n\nD'où viennent les chiffres. Les maqamat suivent la division en quarts de ton adoptée au Congrès du Caire de 1932, qui reste la référence écrite même si les praticiens en dévient. Les ragas sont donnés en intonation juste, comme les shrutis les définissent : la tierce du Bhairav est à 386 cents, la tierce pure, et non les 400 du piano. Les gammes de gamelan sont des moyennes — chaque ensemble est accordé pour lui-même, et deux gamelans ne jouent pas la même gamme. C'est une propriété du genre, pas une imprécision de la mesure.\n\nEt cela répond à la courbe de dissonance. L'exemple central de Sethares est précisément le gamelan : les métallophones ont des spectres inharmoniques, et slendro comme pelog suivent ces spectres plutôt que la série harmonique. L'octave du slendro vaut 1208 cents et non 1200 — elle est étirée, comme le sont ces spectres. Brancher un enregistrement de gamelan sur « Courbe de dissonance » et comparer les creux obtenus aux degrés listés ici est la vérification que Sethares propose lui-même.",
    noticeEn: "The Scale node knew seven church modes and two pentatonics; the Temperament node, the historical Western temperaments. Neither maqam, nor raga, nor gamelan.\n\nThis was not an oversight in a list: these systems do not fit in twelve equal semitones. Maqam Rast has a third midway between major and minor; the Indian shrutis divide the octave into twenty-two unequal degrees; Javanese slendro has neither a just octave nor an equal interval. Writing them takes cents, not note numbers — and that is why this node returns frequencies and never keys.\n\nWhere the figures come from. The maqamat follow the quarter-tone division adopted at the 1932 Cairo Congress, which remains the written reference even where practitioners depart from it. The ragas are given in just intonation, as the shrutis define them: Bhairav's third is at 386 cents, the pure third, not the piano's 400. The gamelan scales are averages — each ensemble is tuned for itself, and two gamelans do not play the same scale. That is a property of the genre, not an imprecision of the measurement.\n\nAnd this answers the dissonance curve. Sethares' central example is precisely the gamelan: metallophones have inharmonic spectra, and both slendro and pelog follow those spectra rather than the harmonic series. Slendro's octave is 1208 cents and not 1200 — it is stretched, as those spectra are. Feeding a gamelan recording into « Dissonance Curve » and comparing the dips obtained to the degrees listed here is the verification Sethares himself proposes.",
    entrees: [],
