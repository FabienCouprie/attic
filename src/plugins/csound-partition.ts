...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      champ("p5", "p5", "amplitude",
        "Ce que porte le cinquième champ. L'amplitude — la vélocité ramenée entre 0 et 1 — y est l'usage, `0dbfs` valant 1 dans Attic.",
        "What the fifth field carries. Amplitude — velocity brought to the 0–1 range — is the custom, `0dbfs` being 1 in Attic."),
      champ("p6", "p6", "note",
