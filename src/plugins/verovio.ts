...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Échelle", nomEn: "Scale", type: "curseur", plage: [10, 200], pas: 5, defaut: 40, unite: "%",
        doc: "Taille de la gravure. Petite, la partition tient en entier dans le nœud ; grande, elle se lit.",
