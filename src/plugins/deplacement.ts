...
import { decoderStereo, encoderStereo, tourner } from "../audio/ambisonique";
...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "L'effet décrit par Christian Doppler en 1842. Attic sait spatialiser — le panoramiseur HRTF, la scène de Resonance Audio — mais il ne sait rien déplacer : ses sources sont posées et n'en bougent plus.\n\nCe nœud ne transpose pas le son d'un rapport calculé. Il pose le retard égal au temps que le son met à parcourir la distance, et laisse le décalage de hauteur en sortir tout seul. C'est ce qui donne la bascule juste au moment du passage, là où une transposition par un rapport fixe se trompe : la vitesse radiale s'inverse alors, et aucun rapport constant ne peut le décrire.\n\nLe point à connaître, parce qu'il a été mesuré : la distance est prise à l'instant d'émission et non d'arrivée. Prendre l'instant d'arrivée revient à faire bouger l'auditeur plutôt que la source, et donne une hauteur trop basse de vingt-quatre centièmes de demi-ton — assez pour s'entendre sur un son tenu.",
    noticeEn: "The effect described by Christian Doppler in 1842. Attic can place sounds in space — the HRTF panner, Resonance Audio's scene — but it cannot move anything: its sources are set down and stay there.\n\nThis node does not transpose the sound by a computed ratio. It sets the delay equal to the time sound takes to cover the distance, and lets the pitch shift fall out of that on its own. This is what gives the right tipping point at the moment of passing, where a fixed-ratio transposition goes wrong: the radial velocity reverses there, and no constant ratio can describe it.\n\nThe point worth knowing, because it was measured: the distance is taken at the instant of emission, not of arrival. Taking the arrival instant amounts to moving the listener rather than the source, and gives a pitch too low by twenty-four hundredths of a semitone — enough to be heard on a sustained sound.",
  ...
  },
  {
    ...
    parametres: [
      { nom: "Rotation", nomEn: "Rotation", type: "curseur", plage: [-180, 180], pas: 1, defaut: 90, unite: "°",
        doc: "De combien la scène tourne, dans le sens direct. À 180°, la gauche et la droite sont échangées ; à 90°, ce qui était à gauche passe devant. Une courbe branchée sur l'entrée Modulation fait tourner la scène en continu.",
        docEn: "How far the scene turns, counter-clockwise. At 180° left and right are swapped; at 90°, what was on the left comes to the front. A curve connected to the Modulation input turns the scene continuously." },
      { nom: "Écart des sources", nomEn: "Source spread", type: "curseur", plage: [30, 180], pas: 5, defaut: 90, unite: "°",
        doc: "Angle entre les deux sources dont on reconstitue la scène. Étroit, la prise est traitée comme deux voix presque devant soi ; large, comme deux voix sur les côtés — et la rotation y sera d'autant plus spectaculaire.",
        docEn: "Angle between the two sources whose scene is reconstituted. Narrow, the take is treated as two voices almost in front; wide, as two voices at the sides — and the rotation will be all the more striking." },
