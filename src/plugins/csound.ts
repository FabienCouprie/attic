...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Graine", nomEn: "Seed", type: "nombre", plage: [0, 999999], pas: 1, defaut: 1,
        doc: "Graine des opcodes aléatoires. Csound est reproductible dès qu'elle est fixée, ce qu'Attic exige : 0 laisse Csound tirer la sienne et le rendu change à chaque exécution.",
        docEn: "Seed of the random opcodes. Csound is reproducible as soon as it is fixed, which Attic requires: 0 lets Csound draw its own and the render changes on every run." },
  ...
  },
  {
    ...
    parametres: [
      { nom: "Instrument", nomEn: "Instrument", type: "choix",
        ...
        doc: "L'opcode employé. La corde frottée est celle qu'Attic ne savait pas écrire à la main : son modèle de Helmholtz est ici débogué depuis trente ans. Chaque instrument emploie les trois réglages suivants à sa façon, et la notice le détaille.",
        docEn: "The opcode used. The bowed string is the one Attic could not write by hand: its Helmholtz model has been debugged here for thirty years. Each instrument uses the three settings below in its own way, detailed in the notice." },
  ...
  },
  {
    ...
    parametres: [
      { nom: "Traitement", nomEn: "Process", type: "choix",
        ...
        doc: "L'opcode employé. Les trois premiers demandent deux sons et les croisent ; l'étirement n'en demande qu'un. Attic n'avait aucun morphing spectral avant eux.",
        docEn: "The opcode used. The first three need two sounds and cross them; the stretch needs only one. Attic had no spectral morphing before these." },
