...
const ALIAS_MANUELS: { ficheId: string; mots: string[]; category: Category }[] = [
  ...
  { ficheId: "sequenceur-batterie-avance", mots: ["séquenceur batterie avancé", "advanced drum sequencer", "drum machine avancée", "grille velocity batterie", "séquenceur batterie", "drum sequencer", "boîte à rythmes", "drum machine"], category: "source" },
  ...
  { ficheId: "inverseur-audio", mots: ["inverse", "reverse", "retourner", "envers"], category: "effet" },
  { ficheId: "inversion-polarite", mots: ["polarite", "polarity", "phase"], category: "effet" },
