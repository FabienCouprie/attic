...
export const fiches: FicheAudio[] = ([
  {
    ...
    async executer(ctx: any) {
      ...
      const image = new File([svg], "cercle-pulsant.svg", { type: "image/svg+xml" });
      ...
      return {
        valeurs: [image, midi, audio, lignes.join("\n")],
