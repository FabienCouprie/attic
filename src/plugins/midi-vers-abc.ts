...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      { nom: "Métrique", nomEn: "Meter", type: "choix",
        ...
        doc: "Où placer les barres. Attention : les nœuds écrivent tous « 4/4 » dans leurs fichiers, même pour une valse — « Du fichier » donne donc presque toujours 4/4. La métrique se donne à la main ; elle n'est pas devinée, parce qu'une métrique mal devinée donne une partition illisible sans le dire.",
