...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      { nom: "Fenêtre", nomEn: "Window", type: "choix",
        ...
        doc: "Taille de la transformée. La fenêtre est gaussienne et non de Hann comme ailleurs dans Attic : c'est la seule pour laquelle la relation entre phase et magnitude est exacte, et c'est cette relation qui fait tout l'algorithme.",
        docEn: "Transform size. The window is gaussian rather than the Hann used elsewhere in Attic: it is the only one for which the relation between phase and magnitude is exact, and that relation is the whole algorithm." },
