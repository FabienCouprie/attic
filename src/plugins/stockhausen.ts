...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "D'après la découverte que Karlheinz Stockhausen formule en composant « Kontakte » (1960) : hauteur, timbre et rythme ne sont pas trois phénomènes distincts mais UN seul, observé à trois échelles de temps. Une impulsion répétée 200 fois par seconde s'entend comme une note de 200 Hz ; ralentie mille fois, la même impulsion s'entend comme une pulsation toutes les cinq secondes. Rien ne change dans le signal sinon l'échelle, et pourtant l'oreille bascule d'une catégorie à l'autre, quelque part autour de 20 Hz. Le composant fait traverser cette frontière au son, continûment, et l'on entend l'endroit exact où la hauteur se décompose en rythme. Le composant demande une source périodique et bien marquée — un train d'impulsions, une note tenue, un motif percussif court : c'est sa périodicité qui devient le rythme. Sur un son sans périodicité franche, il ne se passe rien d'audible sinon un ralenti. Mécaniquement, il s'agit d'une lecture à vitesse variable, comme le mode « Bande » du glissando de Risset ; ce qui change tout est l'amplitude du balayage — une dizaine d'octaves, soit un facteur mille, là où un glissando en parcourt quelques-unes.",
