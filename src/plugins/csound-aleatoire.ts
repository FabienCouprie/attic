...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Durée max", nomEn: "Longest", type: "nombre", plage: [0.01, 20], pas: 0.01, defaut: 1, unite: "s",
        doc: "Durée la plus longue. Si elle est plus longue que l'intervalle moyen, les événements se superposent ; c'est ainsi qu'on obtient une masse plutôt qu'une succession.",
