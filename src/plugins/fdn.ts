...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Fréquence de l'aigu", nomEn: "High reference", type: "curseur", plage: [1000, 16000], pas: 100, defaut: 8000, unite: "Hz",
        doc: "Fréquence à laquelle « RT60 aigu » est exact. Elle existe parce que la première version résolvait le filtre à Nyquist, ce qui est plus simple mais rend le réglage trompeur : on lit 0,73 s à 18 kHz pour 0,50 demandée, l'exactitude tombant à une fréquence que personne n'écoute. En la plaçant ici, le réglage annonce ce qu'on entend.",
