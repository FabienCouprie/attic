...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      { nom: "Thème", nomEn: "Theme", type: "choix",
        ...
        doc: "« Tout » alterne les six thèmes, ce qui est le réglage pour lequel le tirage a été conçu. Un thème seul sert à réviser un point : les sigles avant un entretien, les formules avant d'écrire un traitement. « Catalogue » est le seul thème calculé — il interroge sur les nœuds installés, et grossit tout seul à chaque nœud ajouté.",
