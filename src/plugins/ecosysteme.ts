...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Durée", nomEn: "Duration", type: "curseur", plage: [1, 120], pas: 1, defaut: 15, unite: "s",
        doc: "La durée de la sortie, indépendante de celle du monde. C'est ici que le nœud se distingue d'un effet : demandez trente secondes pour une entrée d'une seconde, et écoutez ce que le système devient une fois le monde parti.",
      ...
      { nom: "Homéostat", nomEn: "Homeostat", type: "choix",
        ...
        doc: "Le témoin du nœud, et il est fait pour être débranché. La même boucle, les mêmes grains, la même mémoire, sans la régulation : le système suit alors le volume du monde au lieu de tenir le sien. Mesuré, trois mondes distants de trente-quatre décibels rendent trois sorties distantes de 1,13 dB avec l'homéostat, et de 33,19 dB sans lui.",
      ...
      { nom: "Graine", nomEn: "Seed", type: "curseur", plage: [1, 9999], pas: 1, defaut: 7,
        doc: "Deux graines donnent deux sons qui ne se ressemblent en rien échantillon par échantillon, et se ressemblent en tout statistiquement — mêmes niveaux, mêmes densités. Ce que le nœud rend n'est pas un objet mais une instance, et la graine sert à retrouver exactement celle qu'on avait aimée.",
