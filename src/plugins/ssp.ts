...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "Synthétise un son point par point, sans modèle de forme d'onde : deux listes de nombres, des amplitudes et des durées, et des principes pour y puiser. D'après Gottfried Michael Koenig, « Sound Synthesis Program » (SSP), Institut de sonologie d'Utrecht, années 1970, dont les principes de sélection viennent de ses programmes Projet 1 (1964) et Projet 2 (1966). Voir aussi Luc Döbereiner, « Models of Constructed Sound : Nonstandard Synthesis as an Aesthetic Perspective », Computer Music Journal 35(3), 2011.\n\nCe que « non standard » veut dire. Toute la synthèse ordinaire part d'un modèle : un oscillateur, une forme d'onde, un spectre, une enveloppe, un instrument. Ici il n'y a rien de tout cela. Le composant prend deux listes de nombres, des amplitudes et des durées, et des principes pour y puiser. Les couples ainsi tirés sont des points, et le son est le trait qui les relie. Pas de hauteur, pas de note, pas de timbre : la hauteur qu'on entendra est une conséquence des durées écrites, jamais un réglage.\n\nLa thèse de Koenig. Les mêmes principes valent à toutes les échelles : ce qui ordonne les points d'une forme d'onde ordonne aussi les sections d'une pièce. C'est pourquoi le même choix de cinq mots est offert pour les amplitudes, pour les durées et pour l'ordre des sections. Une série veut dire exactement la même chose aux trois échelles, chaque élément une fois avant qu'aucun ne repasse.\n\nKoenig a constaté que le programme résistait à l'intention musicale, et l'écrasante majorité des réglages rend du bruit. Deux grandeurs se commandent. Les durées font l'aigu : le centre de gravité du spectre va de 9 Hz pour des durées de mille échantillons à 4 419 Hz pour des durées de deux ou trois, soit près de cinq cents pour un. Les amplitudes font la crête : de 1,81 dB pour deux valeurs extrêmes à 8,38 dB pour beaucoup de petites et une grande. Et les deux axes sont séparés, changer les amplitudes ne déplace pas l'aigu, changer les durées ne change pas la crête.\n\nL'ordre de travail. Les durées décident de la région où le son se tiendra : autour de trois échantillons pour un sifflement aigu, autour de cinquante pour un registre médian, au-delà de cinq cents pour des reliefs qu'on entend défiler plutôt que sonner. Les amplitudes décident du relief : deux valeurs extrêmes donnent un son plein et droit, un mélange de petites et de grandes donne un son creusé. Les principes viennent en dernier.\n\nUne tendance appliquée aux amplitudes dessine une rampe qui traverse l'ensemble d'un bout à l'autre, et non un son : à l'échelle d'une section entière, cela ne s'entend que comme un déplacement lent. La tendance agit à l'échelle de la forme, où Koenig l'employait.\n\nÀ graine égale, le composant rend deux fois le même son ; à graine différente, deux sons sans rapport tirés du même matériau.",
    noticeEn: "Synthesises a sound point by point, with no waveform model: two lists of numbers, amplitudes and durations, and principles for drawing from them. After Gottfried Michael Koenig, « Sound Synthesis Program » (SSP), Institute of Sonology, Utrecht, in the 1970s, whose selection principles come from his programs Project 1 (1964) and Project 2 (1966). See also Luc Dobereiner, « Models of Constructed Sound: Nonstandard Synthesis as an Aesthetic Perspective », Computer Music Journal 35(3), 2011.\n\nWhat « nonstandard » means. All ordinary synthesis starts from a model: an oscillator, a waveform, a spectrum, an envelope, an instrument. Here there is none of that. The node takes two lists of numbers, amplitudes and durations, and principles for drawing from them. The pairs so drawn are points, and the sound is the line joining them. No pitch, no note, no timbre: the pitch heard is a consequence of the durations written, never a setting.\n\nKoenig's thesis. The same principles hold at every scale: what orders the points of a waveform also orders the sections of a piece. That is why the same choice of five words is offered for the amplitudes, for the durations and for the order of the sections. A series means exactly the same thing at all three scales, each element once before any repeats.\n\nKoenig found that the program resisted musical intention, and the overwhelming majority of settings return noise. Two quantities are under command. The durations make the treble: the spectrum's centre of gravity runs from 9 Hz for durations of a thousand samples to 4,419 Hz for durations of two or three, close to five hundred to one. The amplitudes make the crest: from 1.81 dB for two extreme values to 8.38 dB for many small ones and one large. And the two axes are separate: changing the amplitudes does not move the treble, changing the durations does not change the crest.\n\nThe durations decide the region where the sound will sit: around three samples for a high whistle, around fifty for a middle register, beyond five hundred for reliefs you hear going past rather than sounding. The amplitudes decide the relief: two extreme values give a full, straight sound, a mixture of small and large gives a hollowed one. The principles come last.\n\nA tendency applied to the amplitudes draws a ramp crossing the set from end to end, not a sound: at the scale of a whole section it is heard only as a slow drift. Tendency acts at the scale of form, which is where Koenig used it.\n\nAt equal seed the node returns the same sound twice; at a different seed, two unrelated sounds drawn from the same material.",
    entrees: [],
    sorties: [
