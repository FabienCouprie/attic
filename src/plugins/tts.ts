...
const VOIX_SPEECHT5 = [
  { id: "bdl", nom: "Homme américain (BDL)", url: `${BASE_VOIX}/cmu_us_bdl_arctic-wav-arctic_a0001.bin` },
  { id: "slt", nom: "Femme américaine (SLT)", url: `${BASE_VOIX}/cmu_us_slt_arctic-wav-arctic_a0001.bin` },
  { id: "clb", nom: "Femme américaine (CLB)", url: `${BASE_VOIX}/cmu_us_clb_arctic-wav-arctic_a0001.bin` },
  { id: "rms", nom: "Homme américain (RMS)", url: `${BASE_VOIX}/cmu_us_rms_arctic-wav-arctic_a0001.bin` },
  { id: "jmk", nom: "Homme canadien (JMK)", url: `${BASE_VOIX}/cmu_us_jmk_arctic-wav-arctic_a0001.bin` },
  { id: "awb", nom: "Homme écossais (AWB)", url: `${BASE_VOIX}/cmu_us_awb_arctic-wav-arctic_a0001.bin` },
  { id: "ksp", nom: "Homme indien (KSP)", url: `${BASE_VOIX}/cmu_us_ksp_arctic-wav-arctic_a0001.bin` },
];
...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      { nom: "Voix", nomEn: "Voice", type: "choix",
        options: VOIX_SPEECHT5.map((v) => v.id), optionsEn: VOIX_SPEECHT5.map((v) => v.nom),
        defaut: "bdl",
        ...
        docEn: "Preset voice (CMU Arctic embeddings). BDL/RMS = US males; SLT/CLB = US females; JMK = Canadian male; AWB = Scottish male; KSP = Indian male." },
    ],
  ...
  },
  {
    ...
    parametres: [
      { nom: "Langue", nomEn: "Language", type: "choix",
        ...
        docEn: "Language of the text to synthesize. Determines which MMS model is used." },
    ],
    async executer(ctx: any) {
      const texte = ctx.entree(0);
      if (typeof texte !== "string" || !texte.trim()) return { valeurs: [null], message: "Branchez un texte (port bleu)." };
