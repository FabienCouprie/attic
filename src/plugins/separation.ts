...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "Sépare une piste en stems. Demucs (HT) = 4 pistes (batterie, basse, voix, autre). Demucs 6s = 6 pistes (batterie, basse, voix, autre, guitare, piano). MDX-Net = voix + instrumental. Les modèles par défaut sont embarqués (public/oonx/) et chargés automatiquement. Un modèle .onnx personnel se charge par le bouton du nœud, ou par une URL.",
