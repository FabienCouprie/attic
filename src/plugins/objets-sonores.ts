...
export const fiches: FicheAudio[] = ([
  ...
  },
  {
    ...
    univers: "Traitement", famille: "Montage",
    resume: "Pose des sons sur une ligne de temps, chacun à son instant, à son niveau, avec ses fondus ; le nœud s'allonge d'une piste à la demande.",
