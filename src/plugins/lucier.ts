...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "D'après « I Am Sitting in a Room » d'Alvin Lucier (1969), dont le principe est d'enregistrer une voix dans une pièce, rejouer l'enregistrement dans cette même pièce, ré-enregistrer, et recommencer. À chaque passage, les fréquences que la pièce favorise sont renforcées et celles qu'elle absorbe s'effacent un peu plus ; au bout de quelques dizaines de passages il ne reste plus de parole, rien que les modes de résonance du lieu devenus un accord tenu. Ce n'est pas une réverbération très mouillée : un espace est un filtre, et l'appliquer un grand nombre de fois ne fait pas « plus de la même chose » — cela transforme le filtre en son. Le paramètre décisif est donc le nombre d'itérations : en dessous de 5 on entend une coloration, vers 15-20 la source devient méconnaissable, au-delà de 30 il ne reste que la pièce. Les autres réglages décrivent l'espace, exactement comme sur le composant de réverbération à convolution. À savoir : le pré-délai s'accumule d'un passage à l'autre et repousse progressivement le son ; c'est le comportement attendu, pas un défaut.",
    noticeEn: "After Alvin Lucier's \"I Am Sitting in a Room\" (1969), whose principle is to record a voice in a room, play the recording back into that same room, re-record, and repeat. With each pass the frequencies the room favours are reinforced and those it absorbs fade further; after a few dozen passes no speech is left, only the room's resonant modes turned into a sustained chord. This is not a very wet reverb: a space is a filter, and applying it many times does not give \"more of the same\" — it turns the filter into the sound. The decisive parameter is therefore the iteration count: below 5 you hear colouring, around 15-20 the source becomes unrecognisable, past 30 only the room remains. The other settings describe the space, exactly as on the convolution reverb node. Note: the pre-delay accumulates from pass to pass and progressively pushes the sound later; that is expected behaviour, not a fault.",
