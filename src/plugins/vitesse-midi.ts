...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Pourcentage", nomEn: "Percentage", type: "curseur", plage: [10, 800], pas: 5, defaut: 100, unite: "%",
        doc: "La même chose en pour cent de la vitesse d'origine : 75 % pour un ralenti d'un quart, 200 % pour le double.",
      ...
      { nom: "Tempo cible", nomEn: "Target tempo", type: "nombre", plage: [20, 300], pas: 1, defaut: 120, unite: "BPM",
        doc: "Le tempo auquel jouer le fichier. Le facteur en découle : un fichier à 120 joué à 90 est ralenti à 0,75. Le tempo lu dans le fichier est rappelé dans le message.",
