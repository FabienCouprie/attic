...
export const fiches: FicheAudio[] = ([
 ...
 },
  {
    ...
    entrees: [
      { nom: "Audio", type: "audio" },
      { nom: "Modulation", nomEn: "Modulation", type: "courbe", requis: false, module: "Gain" },
    ],
    sorties: [{ nom: "Audio", type: "audio" }],
    parametres: [
      ...
      {nom:"Modulation min",nomEn:"Modulation min",modulationDe:"Gain",plage:[-60,60],defaut:-24,unite:"dB",
      ...
      {nom:"Modulation max",nomEn:"Modulation max",modulationDe:"Gain",plage:[-60,60],defaut:0,unite:"dB",
