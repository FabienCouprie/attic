...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "Un parcours en dix chapitres — le premier son, l'oreille, le niveau, la couleur, le temps, l'espace, la hauteur, la matière, la musique, l'œuvre — qui ne se valide jamais sur une déclaration. Un tutoriel ordinaire déroule des pages et demande de cliquer « suivant » : il n'apprend rien qu'une documentation n'apprendrait mieux, et il ment sur un point puisqu'il prétend que le geste a été fait. Ici, chaque étape se lit sur quelque chose de réel.\n\nLes exercices se valident sur l'atelier. « Pose un générateur, relie-le à un visualiseur, lance » se vérifie en regardant les nœuds et les arêtes que vous venez de poser. La liste de contrôle se coche pendant que vous travaillez, et le point qui reste rouge dit précisément ce qui manque : le nœud absent, le nœud posé mais pas lancé, le réglage à côté, ou les deux nœuds présents et non reliés. Ce sont quatre échecs différents, et les confondre en un seul « non réussi » aurait supprimé tout l'intérêt.\n\nLes épreuves se mesurent sur le son. Elles ferment chaque chapitre et ne disent rien du chemin : branchez sur l'entrée « Copie » le résultat de votre travail, et le nœud le mesure. Sonie, vrai pic, crête, facteur de crête, corrélation entre canaux, équilibre gauche-droite, part d'énergie sous 200 Hz, hauteur et justesse en cents : les chiffres viennent des mêmes fonctions que le vu-mètre et le suiveur de hauteur du catalogue, si bien qu'une épreuve ne peut pas déclarer réussi ce que ces nœuds déclareraient raté.\n\nLe verdict porte toujours le chiffre mesuré, réussi ou raté. Savoir qu'on est à −24 LUFS quand on en demandait −14 est la seule chose qui permette de corriger ; « raté » n'enseigne rien.\n\nLes leçons disent pourquoi, jamais comment. Le comment est dans l'indice, qu'on ouvre si l'on veut. La leçon, elle, porte la raison — pourquoi le limiteur va après le compresseur, pourquoi un grave large s'annule en mono, pourquoi la sonie ne se gagne pas au gain — et c'est ce qui reste quand le geste est oublié, y compris devant un autre logiciel.\n\nRien n'est verrouillé. L'ordre est une proposition : le réglage « Au fil du parcours » mène toujours au premier exercice non accompli, et choisir un chapitre y va directement. Quelqu'un qui vient pour la spatialisation n'a pas à refaire douze exercices de branchement pour y accéder.\n\nLa progression se sauvegarde avec le projet, puisqu'elle vit dans un paramètre. On ferme l'application au milieu du troisième chapitre et on la rouvre là où on l'avait laissée. Le champ se lit en clair et se vide d'un bouton.\n\nDix titres se gagnent aux épreuves, et à elles seules, d'« Oreille neuve » à « Compagnon du son ». Ils ne servent à rien, ce qui est précisément ce qui les rend agréables à obtenir.\n\nEn lançant le nœud, on en sort la feuille de route — les exercices et leurs consignes, qui s'impriment et se distribuent — et le bulletin, avec le compte par chapitre et le verdict de l'épreuve en cours. Branchez-les sur une « Sortie texte » pour les garder.",
    noticeEn: "A journey in ten chapters — the first sound, the ear, level, colour, time, space, pitch, matter, music, the finished work — which never validates on a declaration. An ordinary tutorial flips through pages and asks you to click « next »: it teaches nothing a documentation would not teach better, and it lies on one point, since it claims the gesture was made. Here every step is read off something real.\n\nExercises validate against the workshop. « Place a generator, wire it to a viewer, run » is checked by looking at the nodes and edges you just placed. The checklist ticks itself while you work, and the point left red says precisely what is missing: the absent node, the node placed but not run, the setting beside the mark, or two nodes present and unconnected. Those are four different failures, and folding them into a single « not done » would have removed the whole point.\n\nTrials are measured on the sound. They close each chapter and say nothing about the route: wire the result of your work into the « Copy » input, and the node measures it. Loudness, true peak, peak, crest factor, channel correlation, left-right balance, share of energy below 200 Hz, pitch and tuning in cents: the figures come from the same functions as the catalog's VU-meter and Pitch Follower, so a trial cannot declare passed what those nodes would declare failed.\n\nThe verdict always carries the measured figure, passed or failed. Knowing you are at -24 LUFS when -14 was asked is the only thing that lets you correct; « failed » teaches nothing.\n\nLessons say why, never how. The how is in the hint, which you open if you want. The lesson carries the reason — why the limiter goes after the compressor, why a wide low end cancels in mono, why loudness is not won with gain — and that is what remains once the gesture is forgotten, including in front of another piece of software.\n\nNothing is locked. The order is a proposal: the « Along the journey » setting always leads to the first unfinished exercise, and choosing a chapter goes straight there. Someone who came for spatialization should not have to redo twelve wiring exercises to reach it.\n\nProgress is saved with the project, since it lives in a parameter. You close the application halfway through the third chapter and reopen it where you left off. The field reads plainly and clears with one button.\n\nTen titles are earned at the trials, and at the trials alone, from « New ear » to « Journeyman of sound ». They are good for nothing, which is exactly what makes them pleasant to get.\n\nRunning the node returns the roadmap — the exercises and their instructions, which print and hand out — and the report card, with the per-chapter count and the verdict of the trial under way. Connect them to a « Text Output » to keep them.",
    entrees: [{ nom: "Copie", nomEn: "Copy", type: "audio" }],
    sorties: [
