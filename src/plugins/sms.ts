...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      { nom: "Transposition", nomEn: "Transpose", type: "curseur", plage: [-24, 24], pas: 1, defaut: 0,
        ...
        doc: "Transposition des seuls partiels. Le résidu (souffle, archet, bruit d'attaque) n'en sait rien et reste à sa place : ce qu'une transposition ordinaire ne permet pas. Dès qu'elle n'est pas nulle, les partiels sont refabriqués par addition d'oscillateurs plutôt que découpés dans le son d'origine.",
        docEn: "Transposes the partials only. The residual (breath, bow, attack noise) knows nothing of it and stays where it is: which an ordinary pitch shift does not allow. As soon as it is non-zero, the partials are rebuilt by adding oscillators rather than cut out of the original sound." },
