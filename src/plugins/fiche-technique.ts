...
export const fiches: FicheAudio[] = ([
  {
    ...
    notice: "Une seule page qui dit tout ce que le logiciel sait mesurer d'un son, et le laisse passer inchangé. On le pose au milieu d'une chaîne comme un vu-mètre, sans rien débrancher.\n\nCe nœud est né d'un défaut. Les épreuves du nœud « Parcours » mesurent des choses qu'aucun nœud ne disait : la part d'énergie sous 200 hertz, la corrélation des deux canaux, l'équilibre gauche-droite, l'écart au demi-ton le plus proche. Un élève lisait donc un verdict — « corrélation 0,24 » — sans pouvoir le retrouver nulle part. L'examinateur voyait plus que l'utilisateur, et un jugement qu'on ne peut pas reproduire n'enseigne rien : il intimide. La fiche rend exactement les mêmes chiffres, par les mêmes fonctions.\n\nLes mesures de niveau viennent du vu-mètre du catalogue, la hauteur du suiveur pYIN : la fiche ne peut donc contredire ni l'un ni l'autre.\n\nTrois cibles de diffusion sont proposées avec leurs vraies valeurs — les plateformes à −14 LUFS, le balado à −16, la radio et la télévision à −23 selon la norme EBU R 128 —, toutes avec un plafond de vrai pic à −1 dBTP. Le verdict passe par la même fonction que les épreuves du parcours : une conformité écrite à part aurait fini par diverger d'un dixième de décibel, et c'est précisément l'écart qui fait douter d'un outil de mesure.\n\nCe qui n'est pas affiché compte autant. Sur un son mono, la rubrique stéréo est absente au lieu d'annoncer une corrélation de 1,000 et un équilibre de 0,00 dB : deux chiffres exacts qui laisseraient croire à une mesure alors qu'ils répètent seulement qu'il n'y a qu'un canal. Sans hauteur tenue, la fiche le dit en un mot plutôt que d'aligner des cents sur du bruit.\n\nUn intitulé porte sa réserve : la plage de sonie compte les silences, et un blanc y suffit à annoncer cent décibels. C'est la valeur qu'affiche le vu-mètre, donc juste ; elle est écrite « silences compris » parce qu'un chiffre juste et trompeur est pire qu'un chiffre absent.\n\nL'analyse de hauteur se débranche. Elle demande une transformée par trame, bornée aux huit premières secondes : négligeable sur une prise, sensible sur une collection de deux cents fichiers, inutile sur de la percussion qui n'a aucune hauteur à trouver.",
