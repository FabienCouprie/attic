...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Vérifier", nomEn: "Verify", type: "choix", options: ["Oui", "Non"], optionsEn: ["Yes", "No"],
        ...
        doc: "Remesurer le son produit et afficher l'écart famille par famille. C'est la seule preuve que le nœud s'approche de quelque chose, et cela double son temps de calcul. « Non » ne rend que le son.",
