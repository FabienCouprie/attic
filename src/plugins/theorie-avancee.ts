  ...
  },
  {
    ...
    parametres: [
      ...
      { nom: "Voix aiguë", nomEn: "Upper voice", type: "texte", defaut: "G4 F4 G4 A4 G4 B4 C5",
        ...
        doc: "Le contrepoint, une note par temps, autant de notes que la voix grave. La valeur par défaut est un exercice juste : le nœud ne doit rien y trouver.",
  ...
  },
  {
    ...
    parametres: [
      ...
      { nom: "Motif", nomEn: "Motif", type: "texte", defaut: "0 1 2", defautEn: "0 1 2",
        doc: "Les positions frappées par une voix, en numéros de pulsation. Laissez vide pour que le nœud cherche lui-même un motif qui pave.",
