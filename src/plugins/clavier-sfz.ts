...
export const fiches: FicheAudio[] = ([
  {
    ...
    parametres: [
      ...
      { nom: "Relâchement", nomEn: "Release", type: "curseur", plage: [1, 2000], pas: 1, defaut: 150, unite: "ms",
        doc: "Temps d'extinction après le relâchement de la touche. Si le fichier SFZ déclare un `ampeg_release`, il est affiché dans le message du nœud — mais c'est bien ce réglage qui s'applique, pour que le nœud reste maître de ce qu'il rend.",
