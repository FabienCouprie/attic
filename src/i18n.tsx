...
const DICO: Record<string, Record<Langue, string>> = {
  ...
  "btn.arreterExecution": {
    fr: "Arrêter l'exécution — les résultats déjà calculés sont conservés (Espace)",
    en: "Stop the run — results already computed are kept (Space)",
  },
  ...
  "inspecteur.defaut": { fr: "par défaut :", en: "default:" },
