...
const DICO: Record<string, Record<Langue, string>> = {
  ...
  "persistance.importSansNoeuds": { fr: "Ce fichier ne contient aucun composant sur le canevas (seulement {nb} méta-composant(s) de catalogue) — le canevas restera vide, ce n'est pas un échec d'import.", en: "This file has no canvas nodes (only {nb} catalog meta-component(s)) — the canvas will stay empty, this isn't an import failure." },
  ...
  "montageVideo.sansFilm": { fr: "Choisissez un film dans « Chemin »", en: "Choose a film in « Path »" },
  "montageVideo.sansLecteur": { fr: "Le film se regarde dans l'application de bureau", en: "The film is watched in the desktop application" },
  "montageVideo.aucunePiste": { fr: "Aucune piste branchée", en: "No track connected" },
  "montageVideo.image": { fr: "image", en: "frame" },
  "montageVideo.enregistrer": { fr: "Enregistrer le film sonorisé", en: "Save the scored film" },
  ...
  "code.ia.titre": { fr: "Écrire avec un modèle local", en: "Write with a local model" },
  "code.ia.placeholder": { fr: "ce que le script doit faire, en une phrase", en: "what the script should do, in one sentence" },
  ...
  "modifierTexte.inchange": { fr: "texte d'entrée inchangé", en: "input text unchanged" },
  "modifierTexte.reprendre": { fr: "Reprendre l'entrée", en: "Take the input back" },
  ...
  "btn.replier": { fr: "Replier le composant", en: "Collapse node" },
  "btn.deplier": { fr: "Déplier le composant", en: "Expand node" },
  ...
  "barre.economieMemoire.active": { fr: "au-delà de 10 min, l'aperçu des composants intermédiaires se construit à la demande", en: "beyond 10 min, intermediate nodes build their preview on demand" },
  ...
  "barre.reinitialiser": { fr: "Réinitialiser tous les composants", en: "Reset every node" },
  ...
  "arbre.titre": { fr: "Arbre", en: "Tree" },
  "arbre.choisir": { fr: "Cliquer une branche pour la retoucher ; clic droit pour la diviser", en: "Click a branch to edit it; right-click to divide it" },
  "arbre.diviser": { fr: "Diviser cette branche", en: "Divide this branch" },
  "arbre.diviser.en": { fr: "Diviser en", en: "Divide into" },
  "arbre.fusionner": { fr: "Défaire la division", en: "Undo the division" },
  "arbre.poids.plus": { fr: "Allonger cette branche", en: "Lengthen this branch" },
  "arbre.poids.moins": { fr: "Raccourcir cette branche", en: "Shorten this branch" },
  "arbre.note": { fr: "Note ; défait un silence ou une liaison", en: "Note; undoes a rest or a tie" },
  "arbre.silence": { fr: "Silence", en: "Rest" },
  "arbre.liee": { fr: "Liée à la précédente", en: "Tied to the previous one" },
  "arbre.note.division": { fr: "Une division ne sonne pas : elle n'a pas d'état", en: "A division does not sound: it has no state" },
  "arbre.silence.division": { fr: "Silence ; la division sera défaite", en: "Rest; the division will be undone" },
  ...
  "bulle.developper": { fr: "Développer", en: "Expand" },
  "bulle.developperTitle": { fr: "Replacer les composants de la bulle sur le canevas", en: "Put the bubble's nodes back on the canvas" },
  "bulle.developperSelection": { fr: "Sélectionnez une bulle à développer.", en: "Select a bubble to expand." },
  "bulle.ouvrir": { fr: "Ouvrir", en: "Open" },
  "bulle.refermer": { fr: "Refermer", en: "Close" },
  "bulle.ouvrirTitle": { fr: "Montrer l'intérieur de la bulle sans la développer", en: "Show the bubble's inside without expanding it" },
  "bulle.developpeeAvantMeta": {
    fr: "{bulles} bulle(s) développée(s) avant de grouper : le méta-composant contiendra {membres} composant(s). Une bulle n'existe que dans son projet, un méta-composant voyage avec le catalogue.",
    en: "{bulles} bubble(s) expanded before grouping: the meta-component will contain {membres} node(s). A bubble exists only in its project, a meta-component travels with the catalog.",
  },
  "meta.badgeTitle": { fr: "Méta-composant", en: "Meta-component" },
  "meta.groupe": { fr: "Groupe", en: "Group" },
  "meta.grouperSelection": { fr: "Sélectionnez au moins deux composants à grouper.", en: "Select at least two nodes to group." },
  ...
  "execution.ecartNiveau": { fr: "Écart de sonie entre la sortie de ce composant et la plus faible de ses entrées", en: "Loudness difference between this component's output and the quietest of its inputs" },
  ...
  "famille.Effets": { fr: "Autres effets", en: "Other effects" },
  ...
  "quiz.astuceLancer": { fr: "Lancez le composant pour en sortir le questionnaire et le corrigé.", en: "Run the node to get the questionnaire and the answer key out of it." },
  "famille.Apprendre": { fr: "Apprendre", en: "Learning" },
  "famille.Vidéo": { fr: "Vidéo", en: "Video" },
  "famille.Réverbération": { fr: "Réverbération", en: "Reverberation" },
  "famille.Écho": { fr: "Écho", en: "Echo" },
  "famille.Étirement": { fr: "Étirement", en: "Stretching" },
  "famille.Topologie": { fr: "Topologie", en: "Topology" },
  // Les familles de « Entrées › Génération » (cf. plugins/familles-palette.ts).
  "famille.Synthétiseurs": { fr: "Synthétiseurs", en: "Synthesizers" },
  "famille.Claviers": { fr: "Claviers", en: "Keyboards" },
  "famille.Fractales": { fr: "Fractales", en: "Fractals" },
  "famille.Réservoirs et aléatoire": { fr: "Réservoirs et aléatoire", en: "Reservoirs and randomness" },
  "famille.Résonance sensorielle": { fr: "Résonance sensorielle", en: "Sensory resonance" },
  "famille.Séquenceurs": { fr: "Séquenceurs", en: "Sequencers" },
  "famille.Xenakis": { fr: "Xenakis", en: "Xenakis" },
  "famille.Rythmes": { fr: "Rythmes", en: "Rhythms" },
  "famille.Générateurs AI": { fr: "Générateurs AI", en: "AI generators" },
  // Les familles de « Visualisation » (cf. plugins/familles-palette.ts).
  "famille.Meyda": { fr: "Meyda", en: "Meyda" },
  "famille.Descripteurs": { fr: "Descripteurs", en: "Descriptors" },
  "famille.Détecteurs": { fr: "Détecteurs", en: "Detectors" },
  "famille.Contrôle": { fr: "Contrôle", en: "Control" },
  "famille.Débruitage": { fr: "Débruitage", en: "Denoising" },
  "famille.Tempo": { fr: "Tempo", en: "Tempo" },
  "famille.Hauteur": { fr: "Hauteur", en: "Pitch" },
  "famille.Logistique": { fr: "Logistique", en: "Logistic" },
  "famille.Égalisation et filtres": { fr: "Égalisation et filtres", en: "Equalisation and filters" },
  "famille.Stéréo": { fr: "Stéréo", en: "Stereo" },
  "famille.Distorsion et modulation": { fr: "Distorsion et modulation", en: "Distortion and modulation" },
  "famille.Spectre": { fr: "Spectre", en: "Spectrum" },
  "famille.Ordre et inversions": { fr: "Ordre et inversions", en: "Order and inversions" },
  "famille.Instruments": { fr: "Instruments", en: "Instruments" },
  "famille.Motifs MIDI": { fr: "Motifs MIDI", en: "MIDI patterns" },
  "famille.Contrôle d enveloppe": { fr: "Contrôle d'enveloppe", en: "Envelope control" },
  "inspecteur.vide": { fr: "Sélectionnez un bloc", en: "Select a block" },
  "montage.ligneTemps": { fr: "Ligne de temps du montage", en: "Montage timeline" },
  ...
  "inspecteur.poignee": { fr: "Tirer pour étendre l'inspecteur sur le canevas — double-clic pour le replier", en: "Drag to extend the inspector over the canvas — double-click to fold it back" },
  ...
  "msg.connecter_chemin_alignement": { fr: "Connectez la sortie « Chemin d'alignement » d'un composant Similarité audio.", en: "Connect the « Alignment path » output of an Audio Similarity node." },
  ...
  "msg.pdf_scanne_sans_texte": { fr: "PDF scanné/image — aucun texte numérique, un OCR serait nécessaire (hors scope de ce composant).", en: "Scanned/image PDF — no digital text, OCR would be needed (out of scope for this node)." },
  ...
  "ports.ajouter": { fr: "Ajouter une entrée", en: "Add an input" },
  "ports.retirer": { fr: "Retirer une entrée — impossible tant qu'elle est branchée", en: "Remove an input - not while it is connected" },
  "demo.avantLancer": { fr: "Lancez le graphe : la vidéo de démonstration apparaîtra ici.", en: "Run the graph: the demonstration video will appear here." },
  "demo.sauvegarder": { fr: "💾 Sauvegarder la vidéo", en: "💾 Save the video" },
  "demo.filmer": { fr: "🎬 Filmer l'application", en: "🎬 Film the application" },
  "demo.filmerTitre": { fr: "Reconstruit le graphe à l'écran, le lance et fait entendre chaque composant, en filmant la fenêtre. Échap interrompt.", en: "Rebuilds the graph on screen, runs it and plays each node, while filming the window. Esc stops." },
  "demoApp.ajouter": { fr: "On ajoute « {nom} » — {chemin}", en: "Adding « {nom} » — {chemin}" },
  "demoApp.relier": { fr: "On relie « {source} » à « {cible} »", en: "Connecting « {source} » to « {cible} »" },
  "demoApp.regler": { fr: "Les réglages de « {nom} », dans l'inspecteur", en: "The settings of « {nom} », in the inspector" },
  "demoApp.lancer": { fr: "On lance le graphe", en: "Running the graph" },
  "demoApp.ecouter": { fr: "« {nom} » : son résultat", en: "« {nom} »: its result" },
  "demoApp.fin": { fr: "Le graphe complet", en: "The complete graph" },
  "demoApp.captureRefusee": { fr: "La capture de la fenêtre n'a pas pu démarrer.", en: "Window capture could not start." },
  "demoApp.redemarrer": { fr: "redémarrez Attic : la capture de fenêtre vient d'être ajoutée au processus principal", en: "restart Attic: window capture has just been added to the main process" },
  ...
  "modeles.sansAdresse": { fr: "{__VAR_0__} modèle(s) IA n'ont pas encore de source publiée : les composants qui s'en servent resteront muets.", en: "{__VAR_0__} AI model(s) have no published source yet: the nodes that use them will stay silent." },
  "modeles.tout": { fr: "Tout prendre - {__VAR_0__} modeles, {__VAR_1__}", en: "Take all - {__VAR_0__} models, {__VAR_1__}" },
  "modeles.prendre": { fr: "Telecharger {__VAR_0__}", en: "Download {__VAR_0__}" },
  "modeles.partiel": { fr: "{__VAR_0__} n est la qu a moitie : il se reprend en entier.", en: "{__VAR_0__} is only half there: it is taken again whole." },
  "modeles.rienAPrendre": { fr: "Tous les modeles publies sont presents.", en: "Every published model is present." },
...
const DICO_RUNTIME: Record<string, Record<Langue, string>> = {
  ...
  "msg.branchez_audio_profil_n_ud_profil_de_bruit": { fr: "Branchez audio + profil (composant Profil de bruit).", en: "Connect audio + profile (node Noise profile)." },
  ...
  "msg.graphe_embarqu_d_tect_var_0_nodes_var_1_connexions": { fr: "Graphe embarqué détecté ! {__VAR_0__} composants · {__VAR_1__} connexions", en: "Onboard graph detected! {__VAR_0__} nodes · {__VAR_1__} connections" },
  ...
  "msg.aucune_coordonnee_recue": { fr: "Aucune coordonnée reçue en entrée. Branchez la sortie « Coordonnées » d'un composant de classification.", en: "No coordinates received at input. Connect the « Coordinates » output of a classification node." },
  ...
  "msg.boucle.nonDepliee": { fr: "Boucle non dépliée : reliez ce composant à une « Fin de boucle » (A, B ou C) en aval.", en: "Loop not unrolled: connect this node to a « Loop End » (A, B or C) downstream." },
  ...
  "msg.sfz.sansFichier": { fr: "Aucun fichier : cliquez sur 📂 dans le composant pour désigner un .sfz, ou branchez une banque.", en: "No file: click 📂 in the node to choose a .sfz, or connect a bank." },
  ...
  "msg.sfz.sansSequence": { fr: "rien de joué : enregistrez au clavier du composant", en: "nothing played: record on the node's keyboard" },
  ...
  "msg.cerclePulsant.resume": { fr: "{__VAR_0__} pulsations · {__VAR_1__} notes · {__VAR_2__} accords · {__VAR_3__} tonalités", en: "{__VAR_0__} pulses · {__VAR_1__} notes · {__VAR_2__} chords · {__VAR_3__} keys" },
  ...
  "msg.doc.aucunGraphe": { fr: "Aucun graphe à documenter : ce composant se documente le graphe où il est posé, et il n'en trouve pas.", en: "No graph to document: this node documents the graph it sits in, and finds none." },
  "msg.doc.rendu": { fr: "{__VAR_0__} composants · {__VAR_1__} composants · {__VAR_2__} avertissement(s)", en: "{__VAR_0__} nodes · {__VAR_1__} components · {__VAR_2__} warning(s)" },
  "msg.doc.ecrit": { fr: "{__VAR_0__} composants · {__VAR_1__} composants · {__VAR_2__} fichier(s) écrit(s)", en: "{__VAR_0__} nodes · {__VAR_1__} components · {__VAR_2__} file(s) written" },
  "msg.doc.sansElectron": { fr: "{__VAR_0__} composants documentés, mais l'écriture sur le disque demande Electron : les deux textes sortent par les ports.", en: "{__VAR_0__} nodes documented, but writing to disk requires Electron: both texts leave through the ports." },
  ...
  "msg.csound.orchestreVide": { fr: "Aucun instrument choisi : cochez-en au moins un dans la liste du composant.", en: "No instrument chosen: tick at least one in the node's list." },
  ...
  "msg.canon.nePavePas": { fr: "Le motif « {__VAR_0__} » ne pave pas un cycle de {__VAR_1__} : essayez une autre taille, ou laissez le motif vide pour que le composant en cherche un.", en: "The motif « {__VAR_0__} » does not tile a cycle of {__VAR_1__}: try another size, or leave the motif empty for the node to search for one." },
  ...
  "msg.glissez_un_fichier_audio_sur_le_node": { fr: "Glissez un fichier audio sur le composant.", en: "Drag an audio file onto the node." },
  ...
  "msg.lancez_une_premi_re_fois_pour_peupler_la_liste_puis_s_lectio": { fr: "Lancez une première fois pour peupler la liste, puis sélectionnez un composant et relancez.", en: "Launch the first time to populate the list, then select a node and restart." },
  "msg.node_var_0_introuvable": { fr: "Composant « {__VAR_0__} » introuvable.", en: "Node \"{__VAR_0__}\" not found." },
  ...
  "msg.node_var_0_install_var_1_var_2_var_3_var_4_d_pendance_s_var_": { fr: "✓ Composant « {__VAR_0__} » installé\n{__VAR_1__} · {__VAR_2__}/{__VAR_3__}\n📦 {__VAR_4__} dépendance(s) : {__VAR_5__}", en: "✓ Node \"{__VAR_0__}\" installed\n{__VAR_1__} · {__VAR_2__}/{__VAR_3__}\n📦 {__VAR_4__} dependency(s): {__VAR_5__}" },
  "msg.var_0_instruments_var_1": { fr: "{__VAR_0__} instruments{__VAR_1__}", en: "{__VAR_0__} instruments{__VAR_1__}" },
  "msg.julia_non_trouv_cliquez_sur_configurer_dans_le_node": { fr: "Julia non trouvé. Cliquez sur ⚙ Configurer dans le composant.", en: "Julia not found. Click on ⚙ Configure in the node." },
  ...
  "msg.var_0_nodes_var_1_connexions_var_2": { fr: "{__VAR_0__} composants · {__VAR_1__} connexions\n{__VAR_2__}", en: "{__VAR_0__} nodes · {__VAR_1__} connections\n{__VAR_2__}" },
  ...
  "msg.python_non_trouv_cliquez_sur_configurer_dans_le_node": { fr: "Python non trouvé. Cliquez sur ⚙ Configurer dans le composant.", en: "Python not found. Click on ⚙ Configure in the node." },
  ...
  "msg.aucunPeripheriqueMidi": { fr: "Aucun périphérique MIDI détecté. Branchez un clavier/contrôleur puis rouvrez ce composant.", en: "No MIDI device detected. Plug in a keyboard/controller, then reopen this node." },
  ...
  "msg.texte_image_mod_le_introuvable": { fr: "Modèle SDXS-512 absent. Il ne vient plus avec l'installeur : prenez-le par l'icône « Récupérer les modèles IA » de la barre d'outils, ou indiquez un dossier dans le réglage « Chemin modèle ».", en: "SDXS-512 model missing. It no longer ships with the installer: take it from the « Fetch AI models » icon in the toolbar, or set a folder in the « Model path » setting." },
  ...
  "progress.installation_du_node": { fr: "Installation du composant…", en: "Installation of the node..." },
