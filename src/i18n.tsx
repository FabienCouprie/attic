...
const DICO_RUNTIME: Record<string, Record<Langue, string>> = {
  ...
  "msg.instrument.partielle": { fr: "{__VAR_0__} rendus sur {__VAR_1__} attendus : des copies ont échoué", en: "{__VAR_0__} renders out of {__VAR_1__} expected: some copies failed" },
