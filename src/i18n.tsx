...
const DICO: Record<string, Record<Langue, string>> = {
  ...
  "famille.Convertisseurs de notation": { fr: "Convertisseurs de notation", en: "Notation converters" },
  "famille.Xenakis": { fr: "Xenakis", en: "Xenakis" },
  "famille.Rythmes": { fr: "Rythmes", en: "Rhythms" },
  "famille.IA": { fr: "IA", en: "AI" },
  "famille.Contrôle": { fr: "Contrôle", en: "Control" },
  "famille.Autres générateurs": { fr: "Autres générateurs", en: "Other generators" },
