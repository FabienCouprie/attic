...
const DICO: Record<string, Record<Langue, string>> = {
  ...
  "demo.filmerTitre": { fr: "Reconstruit le graphe à l'écran, le lance et fait entendre chaque nœud, en filmant la fenêtre. Échap interrompt.", en: "Rebuilds the graph on screen, runs it and plays each node, while filming the window. Esc stops." },
