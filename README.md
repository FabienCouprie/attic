...
> 359 nodes · local ML models · bilingual FR/EN · one-click workflows.
...
- **359 plugin nodes** — effects, generators, AI models, collections, separation, visualization, color↔sound, math-formula synthesis (see [`COMPONENTS.md`](COMPONENTS.md), regenerate with `npm run docs:components`)
...
src/
  ...
  plugins/       # Plugin node definitions (359 nodes)
