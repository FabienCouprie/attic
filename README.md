...
> 246 nodes · local ML models · bilingual FR/EN · one-click workflows.
...
- **246 plugin nodes** — effects, generators, AI models, collections, separation, visualization, color↔sound, math-formula synthesis (see [`COMPONENTS.md`](COMPONENTS.md), regenerate with `npm run docs:components`)
...
```bash
npm test     # Vitest (1347 tests across 119 files)
npm run lint # oxlint
```
...
src/
  ...
  plugins/       # Plugin node definitions (246 nodes)
