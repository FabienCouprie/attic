...
- **Thème black : liseret d'exécution en bleu catalogue.** Dans le thème `data-theme="black"`, le liseret du nœud en cours d'exécution (`attic-node.running`) passe du vert au bleu du fond de la palette (`--bg-surface-alt`).
